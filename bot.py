...
country_flags = {
    "easy": [
        ...
        {"name": "France", "flag": "🇫🇷", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZnJhbmNlZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Italy", "flag": "🇮🇹", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaXRhbHlmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRml0YWx5LWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Spain", "flag": "🇪🇸", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExc3BhaW5mbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRnNwYWluLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Portugal", "flag": "🇵🇹", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcG9ydHVnYWxmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRnBvcnR1Z2FsLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Netherlands", "flag": "🇳🇱", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbmV0aGVybGFuZHNmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRm5ldGhlcmxhbmRzLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Belgium", "flag": "🇧🇪", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYmVsZ2l1bWZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRmJlbGdpdW0tZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Switzerland", "flag": "🇨🇭", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExc3dpdHplcmxhbmRmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRnN3aXR6ZXJsYW5kLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Austria", "flag": "🇦🇹", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYXVzdHJpYWZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRmF1c3RyaWEtZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Sweden", "flag": "🇸🇪", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExc3dlZGVuZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Norway", "flag": "🇳🇴", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbm9yd2F5ZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Denmark", "flag": "🇩🇰", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZGVubWFya2ZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRmRlbm1hcmstZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Finland", "flag": "🇫🇮", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZmlubGFuZGZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRmZpbmxhbmQtZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Ireland", "flag": "🇮🇪", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaXJlbGFuZGZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRmlyZWxhbmQtZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Greece", "flag": "🇬🇷", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZ3JlZWNlZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Turkey", "flag": "🇹🇷", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdHVya2V5ZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Russia", "flag": "🇷🇺", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcnVzc2lhZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Poland", "flag": "🇵🇱", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcG9sYW5kZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Ukraine", "flag": "🇺🇦", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWtyYWluZWZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRnVrcmFpbmUtZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Romania", "flag": "🇷🇴", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcm9tYW5pYWZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRnJvbWFuaWEtZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Bulgaria", "flag": "🇧🇬", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExYnVsZ2FyaWFmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRmJ1bGdhcmlhLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Croatia", "flag": "🇭🇷", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExY3JvYXRpYWZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRmNyb2F0aWEtZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Czech Republic", "flag": "🇨🇿", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExY3plY2hmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRmN6ZWNoLXJlcHVibGljLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Hungary", "flag": "🇭🇺", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaHVuZ2FyeWZsYWcmZWNpZD1jb20lMkZnaXBoeSUyRmh1bmdhcnktZmxhZyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Slovakia", "flag": "🇸🇰", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExc2xvdmFraWFmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRnNsb3Zha2lhLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
        {"name": "Slovenia", "flag": "🇸🇮", "gif": "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExc2xvdmVuaWFmbGFnJmVjPWdpcGh5JmNpZD1jb20lMkZnaXBoeSUyRnNsb3ZlbmlhLWZsYWcmZXA9djFfZ2lmc19zZWFyY2gmY2Q9Zw/3o7TKM7tKzKxLzKxLz/giphy.gif"},
    ],
    "medium": [
